...
class dl_uploadgig_com extends Download { 
	...
	public function CheckAcc($cookie){
		...
		if (stristr($data, '<dt>Premium download:</dt>') && stristr($data, '<dd class="text-success">Active</dd>')) return array(true, "Until ".strip_tags($this->lib->cut_str($data, '<dt>Package expire date:</dt>','<span')) ."<br/>Bandwidth Left: ".strip_tags($this->lib->cut_str($data, '<dt>Daily traffic usage:</dt>','<span')));
		elseif (stristr($data, '<dt>Premium download:</dt>')) return array(false, "accfree");
