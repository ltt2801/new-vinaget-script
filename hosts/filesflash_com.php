...
class dl_filesflash_com extends Download
{
    ...
    public function CheckAcc($cookie)
    {
        ...
        if (stristr($data, '<tr><td>Premium Status:</td><td>') && !stristr($data, 'Not Premium')) {
            return array(true, "Until " . $this->lib->cut_str($data, '<tr><td>Premium Status:</td><td>', ' (<a href="premium.php">Buy Premium</a>'));
        } elseif (stristr($data, 'Not Premium')) {
 ...
 * New Vinaget by LTT
 * Version: 3.3 LTS
 * Filesflash.com Download Plugin
 * Date: 01.09.2018
 */
