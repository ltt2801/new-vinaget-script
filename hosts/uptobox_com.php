...
class dl_uptobox_com extends Download
{
    public function CheckAcc($cookie)
    {
        ...
        if (stristr($data, "class='expiration-date")) return array(true, "Until " . $this->lib->cut_str($data, "expiration-date red'>", "</span>"));
        elseif (stristr($data, "My affiliate link:") && !stristr($data, "class='expiration-date")) return array(false, "accfree");
