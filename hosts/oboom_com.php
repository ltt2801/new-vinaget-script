        ...
        if (is_numeric($code)) {
            switch ($code) {
                ...
                case 409:
                    ...
                    break;
                case 410:
                    $msg = 'Gone. The resource you requested is no longer available and will not come back.';
                    break;
                case 413:
                ...
                case 500:
                    ...
                    break;
                case 503:
                    $msg = 'The service is temporary not available.';
                    break;
                case 507:
                    $msg = 'At least one quota like storage space or item count reached.';
                    break;
                case 509:
