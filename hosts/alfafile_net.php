...
class dl_alfafile_net extends Download
{
    public function CheckAcc($cookie)
    {
        ...
        if (stristr($data, "Premium, till")) {
            return array(true, "Premium Until: " . $this->lib->cut_str($data, "Premium, till", "</span>") . "<br/>Bandwidth available: " . $this->lib->cut_str($data, 'sp_bandwidth_used">', '</span'));
    ...
    public function Leech($url)
    {
        ...
        if (stristr($data, "<strong>404</strong>")) {
