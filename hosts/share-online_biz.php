...
class dl_share_online_biz extends Download
{
    ...
    public function CheckAcc($cookie)
    {
        ...
        if (stristr($data, 'Premium        </p>') && stristr($dt, "<span class='red'>")) {
            return array(true, "Until " . $this->lib->cut_str($dt, "<span class='red'>", '</span>'));
        } elseif (stristr($data, 'Premium        </p>') && stristr($dt, "<span class='green'>")) {
            return array(true, "Until " . $this->lib->cut_str($dt, "<span class='green'>", '</span>'));
        } else {
