...
class dl_filestoragepro_net extends Download
{
    ...
    public function CheckAcc($cookie)
    {
        ...
        if (stristr($data, 'http://filestoragepro.net/index.php?logout=1')) {
    ...
    public function Leech($url)
    {
        ...
        if (stristr($data, "That file has been deleted.")) {
        ...
        if ($pass) {
            ...
            if (stristr($data, 'Password Error')) {
 ...
 * New Vinaget by LTT
 * Version: 3.3 LTS
 * Filestoragepro.com Download Plugin
 * Date: 01.09.2018
 */
