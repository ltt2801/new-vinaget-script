...
class dl_mixshared_com extends Download
{
    ...
    public function CheckAcc($cookie)
    {
        ...
        if (stristr($data, 'Premium Expire')) {
            return array(true, "Until " . $this->lib->cut_str($data, 'Premium Expire</b></TD><TD><b>', '</b>&nbsp;&nbsp;&nbsp;'));
        } else if (stristr($data, 'New password') && !stristr($data, 'Premium Expire')) {
 ...
 * New Vinaget by LTT
 * Version: 3.3 LTS
 * Mixedshared.com Download Plugin
 * Date: 01.09.2018
 */
